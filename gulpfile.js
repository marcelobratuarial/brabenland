...
const Paths = {
  ...
  JS: {
    ...
    PLUGINS: ['js/plugins/imagesloaded.pkgd.js','js/plugins/fontawesome-all.js'],
  },
  SCSS: {
    ALL: 'scss/**/*.scss',
...
gulp.task('js:boots4', () => gulp.src(Paths.JS.BOOTS4)
...
gulp.task('js', gulp.parallel('js:bootstrap', 'js:plugins', 'js:boots4'));
...
gulp.task('watch', () => {
  ...
  gulp.watch(Paths.JS.BOOTS4, gulp.series('js', (done) => {
    reload();
    done();
  }));
